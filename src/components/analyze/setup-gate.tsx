...
export function SetupGate({ setup }: { setup: SetupStatus }) {
  ...
  return (
    <div className="rounded-[22px] border border-[rgb(232_180_80_/_0.28)] bg-[rgb(255_236_200_/_0.45)] px-5 py-4 text-sm text-[#7a5410] shadow-[0_8px_24px_rgb(22_72_66_/_0.04)]">
